...
public class ConfirmOrderFragment extends DialogFragment {
    ...
    public void onAttach(Context context) {
        ...
        //viewModel = ViewModelProviders.of(context).get(TapListViewModel.class);
    }
    ...
    private void confirmOrder() {
        TapListFragment parentFragment = (TapListFragment) this.getParentFragment();
        if (parentFragment != null) {
            parentFragment.confirmOrder();
        }
    }
